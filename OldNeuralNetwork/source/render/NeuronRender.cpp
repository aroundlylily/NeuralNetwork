...
NeuronRender::NeuronRender(VisualizationSettings *settings, Neuron *neuron, sf::Vector2f position, sf::Color color) {
        ...
        neuron->setShape(this);
}

sf::Vector2f NeuronRender::getPosition() {
